...
HD_PWD='C:/Users/User/Documents/COD/Register/Register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InstrReg16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InstrReg16.tcl
