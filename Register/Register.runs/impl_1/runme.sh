...
HD_PWD='C:/Users/User/Documents/COD/Register/Register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InstrReg16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InstrReg16.tcl -notrace
